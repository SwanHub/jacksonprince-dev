...
export default function BgRemover() {
  ...
  return (
    <div className="w-full flex flex-col gap-3 font-mono text-sm">
      <span className="self-start flex items-center gap-1.5 rounded-full border border-sky-100 bg-white px-2 py-0.5 text-[10px] uppercase tracking-widest text-zinc-500">
      ...
      {attempted && (
        <div className="flex items-baseline gap-2">
          ...
          <input
            ...
            type="text"
            value={prompt}
            placeholder="e.g. white horse, car, person"
